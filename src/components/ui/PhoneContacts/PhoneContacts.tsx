...
function PhoneContacts({ location, classNames: additionalClasses }: PhoneProps) {
  const PhoneStyles =
    location === 'contacts'
      ? 'font-geologica text-black font-light text-[18px] leading-[24.3px]  md:text-[20px] md:leading-[27px] xl:text-[26px] xl:leading-[35.1px]'
      : 'font-geologica text-black font-light text-[14px] leading-[18.9px] text-center md:font-[250] md:text-[16px] md:leading-[22.4px]';

  const PhoneClasses = classNames(
    'cursor-pointer inline-block transition tracking-[-0.02em] flex font-light',
    PhoneStyles,
    additionalClasses
  );
